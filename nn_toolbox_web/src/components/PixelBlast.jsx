...
export default function PixelBlast({
  ...
  const animationSpeedRef = useRef(speed)
  ...
  useEffect(() => {
    ...
    if (liquid) {
      ...
      liquidPass.renderToScreen = noiseAmount <= 0
    ...
    const animate = () => {
      if (autoPauseOffscreen && !isVisible) {
        rafId = requestAnimationFrame(animate)
        return
      }

      uniforms.uTime.value = randomOffset + clock.getElapsedTime() * animationSpeedRef.current
